            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs text-gray-500">Total: <strong>{{ $divisis->count() }}</strong> divisi</span>
                    </div>
                </div>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 rounded-lg flex items-center justify-center mr-3"
                                            ...
                                            <svg class="w-5 h-5" style="color: {{ $divisi->text_color }};" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                            </svg>
                                        </div>
                                        <div>
                                            <span class="text-sm font-semibold text-gray-900">{{ $divisi->nama_divisi }}</span>
                                            <p class="text-xs text-gray-500 mt-0.5">{{ $divisi->users->count() }} anggota</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <!-- Delete Button -->
                                        <form class="inline" method="POST" action="{{ route('divisi.destroy', $divisi) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm text-gray-500 mb-4">Mulai dengan menambahkan divisi pertama</p>
                                        <a href="{{ route('divisi.create') }}"
