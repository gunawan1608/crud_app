                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.arsip.destroy', $arsip) }}" class="w-full">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                            ...
                            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-red-900 mb-1">Akses Administrator</p>
                                        <p class="text-xs text-red-800">Anda dapat melihat dan mengelola arsip dari semua divisi. Arsip ini milik divisi {{ $arsip->divisi->nama_divisi }}.</p>
                                    </div>
                                </div>
                            </div>
