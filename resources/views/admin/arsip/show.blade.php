<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('admin.arsip.index') }}" class="mr-4 text-gray-600 hover:text-gray-900">
                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-purple-50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <span
                                    class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-800 text-xs font-mono font-semibold rounded mb-2">
                                    {{ $arsip->nomor_arsip }}
                                </span>
                        ...
                        <span
                            class="inline-flex items-center px-3 py-1 bg-red-100 text-red-700 text-xs font-medium rounded-full">
                            Admin View
                        </span>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div>
                                ...
                                <div
                                    class="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg p-4 border border-purple-100">
                                    <div class="flex items-center">
                                        <div
                                            class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-700 rounded-lg flex items-center justify-center text-white font-bold text-sm mr-4 flex-shrink-0">
                                    ...
                                    <div class="flex items-start p-3 bg-green-50 border border-green-200 rounded-lg">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-xs text-gray-600 mt-0.5">
                                                {{ $arsip->created_at->format('d M Y, H:i') }} oleh
                                                {{ $arsip->user->name }}
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex items-start p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-xs text-gray-600 mt-0.5">
                                                    ...
                                                    ({{ $arsip->updated_at->diffForHumans() }})
                                                </p>
                                            </div>
                                        </div>
                                    @endif
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <span
                                        class="inline-flex items-center px-4 py-2 bg-purple-100 text-purple-800 text-sm font-medium rounded-full">
                                        {{ $arsip->kategori }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-900">
                                            {{ $arsip->tanggal_arsip->format('d F Y') }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center mt-1">
                                            <div
                                                class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center text-green-600 font-semibold text-xs mr-2">
                                                {{ strtoupper(substr($arsip->user->name, 0, 2)) }}
                                            </div>
                                            <div>
                                                <p class="text-sm font-medium text-gray-900">{{ $arsip->user->name }}
                                                </p>
                            ...
                            <!-- Actions -->
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h4 class="text-sm font-semibold text-gray-700 mb-3">Tindakan Admin</h4>
                                <div class="space-y-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.arsip.destroy', $arsip) }}"
                                        class="w-full">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            onclick="return confirm('Yakin ingin menghapus arsip ini? Tindakan ini tidak dapat dibatalkan!')"
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-blue-900 mb-1">Informasi Divisi</p>
                                        <p class="text-xs text-blue-800">Arsip ini dikelola oleh divisi
                                            {{ $arsip->divisi->nama_divisi }}.</p>
                                    </div>
                                </div>
                            </div>

                            <!-- File Path Info (Admin Only) -->
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                <h4 class="text-sm font-semibold text-gray-700 mb-2">Informasi Teknis</h4>
                                <div class="space-y-2 text-xs">
                                    <div>
                                        <p class="text-gray-500 mb-1">File Path</p>
                                        <p class="text-gray-700 font-mono break-all">{{ $arsip->file_path }}</p>
                                    </div>
                                    <div>
                                        <p class="text-gray-500 mb-1">ID Arsip</p>
                                        <p class="text-gray-700 font-mono">{{ $arsip->id }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
