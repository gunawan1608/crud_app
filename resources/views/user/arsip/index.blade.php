    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Kelola arsip digital divisi {{ Auth::user()->divisi->nama_divisi }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ $arsips->where('created_at', '>=', now()->startOfMonth())->count() }}</p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4">
                                    <span class="text-sm font-semibold text-gray-900">{{ $arsip->nomor_arsip }}</span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            @if($arsip->keterangan)
                                                <p class="text-xs text-gray-500 mt-1">{{ Str::limit($arsip->keterangan, 50) }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <!-- Delete Button -->
                                        <form class="inline" method="POST" action="{{ route('arsip.destroy', $arsip) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm text-gray-500 mb-4">Mulai dengan menambahkan arsip pertama</p>
                                        <a href="{{ route('arsip.create') }}"
