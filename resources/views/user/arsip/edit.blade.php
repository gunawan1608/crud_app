    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <!-- Form Content -->
                <form method="POST" action="{{ route('arsip.update', $arsip) }}" enctype="multipart/form-data" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select
                                    ...
                                    <option value="Notulen" {{ old('kategori', $arsip->kategori) == 'Notulen' ? 'selected' : '' }}>Notulen</option>
                                    <option value="Proposal" {{ old('kategori', $arsip->kategori) == 'Proposal' ? 'selected' : '' }}>Proposal</option>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="{{ route('arsip.download', $arsip) }}" class="text-blue-600 hover:text-blue-700">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <p class="text-sm text-gray-600">
                                                        <span class="font-semibold text-blue-600 hover:text-blue-700">Klik untuk upload file baru</span>
                                                        atau drag & drop
                                                    </p>
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-amber-800">Jika Anda mengganti file, file lama akan dihapus dan digantikan dengan file baru.</p>
                                </div>
                            </div>
                        </div>
